...
public class ConvertCode {
    ...
    //输入：16进制数低位在前，返回：16进制字符串--->10进制字符串
    public static String HexString2IntString(String HexString){
        String intString = "";
        for (int i = 0; i < HexString.length()-1; i +=2) {
            intString = HexString.substring(i,i+2) + intString;
        }
        System.out.println(intString);
        Integer int2 = Integer.valueOf(intString,16);
        System.out.println(int2);
        return  String.valueOf(int2);
    }
    //对字节数组进行逆序，FEFD10-->10FDFE
    ...
    public static void main(String args[]) {
        String productNo = "223182363";
        Integer hex = Integer.valueOf(productNo,10);
        String strHex = Integer.toHexString(hex);
        System.out.println(strHex);
        //System.out.println("tt:"+HexString2IntString(productNo));
        //System.out.println(Integer.valueOf(productNo,16));
