...
public enum ResultError {
    ...
    PERSON_NO_EXISTS_IN_PROJECT(64, "人员已经从项目中移除"),
    ...
    HAS_UPLOAD_NATION(107, "已经上传到全国平台"),
    NATION_UPLOAD_FAILURE(108, "以下的下发到全国平台失败"),
    NATION_UPDATE_UPLOAD_FAILURE(109, "信息修改后上传到全国平台失败"),
    PROJECT_UN_UPLOAD_NATION(110, "所在项目未上传到全国平台"),
    SUBCONTRACTOR_UN_UPLOAD_NATION(111, "所在参建单位未上传到全国平台"),
    WORKER_GROUP_UN_UPLOAD_NATION(112, "所在班组未上传到全国平台"),
    PERSON_REJOIN_PROJECT_FAILURE(113, "以下人员重新加入项目失败，请检查人员是否已经在其他项目中，或者信息填写不完全"),
    SEND_MESSAGE_ERROR(114, "短信验证码发送失败"),
    AUTH_CODE_ERROR(115, "输入的验证码不正确"),
