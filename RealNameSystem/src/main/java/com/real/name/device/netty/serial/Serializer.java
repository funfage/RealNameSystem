package com.real.name.device.netty.serial;
...
public abstract class Serializer {
	 ...
	 * @param readBuffer
	 */
	private void readFromBuffer(ByteBuf readBuffer) {
	 ...
	 * @return
	 */
	private ByteBuf writeToLocalBuff(){
	 ...
	 * @return
	 */
	private ByteBuf writeToTargetBuff(ByteBuf buffer){
		writeBuffer = buffer;
		write();
		return writeBuffer;
	}
